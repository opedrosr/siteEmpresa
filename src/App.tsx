...
const projects = [
  {
    ...
    description:
      'Uma experiência digital premium criada para apresentar serviços, fortalecer a marca e transformar visitantes em clientes.',
    tags: ['Landing Page', 'UX/UI', 'WhatsApp'],
    accent: 'orange',
    visual: 'rebeca',
    url: 'studio-rebeca',
  },
  {
    ...
    description:
      'Uma plataforma para profissionais organizarem serviços, disponibilidade e agendamentos em uma experiência simples.',
  ...
  },
  {
    ...
    description:
      'Um conceito digital para uma clínica moderna, combinando posicionamento premium, clareza e conversão.',
...
const services = [
  ...
  },
  {
    number: '03',
    title: 'Automação',
    text: 'Integrações e fluxos inteligentes para reduzir tarefas manuais e conectar as partes importantes do seu negócio.',
...
const processSteps = [
  {
    number: '01',
    title: 'Entendimento',
    text: 'Começamos entendendo o seu negócio, objetivo, público e o problema que precisa ser resolvido.',
  },
  {
    number: '02',
    title: 'Estratégia',
    text: 'Definimos a estrutura, a experiência e a solução digital mais adequada para o seu cenário.',
  },
  {
    number: '03',
    title: 'Construção',
    text: 'Transformamos a estratégia em uma experiência digital com tecnologia, design e atenção aos detalhes.',
  },
  {
    number: '04',
    title: 'Evolução',
    text: 'A solução nasce preparada para acompanhar novas necessidades e oportunidades do negócio.',
  },
]
    ...
    >
      ...
      <header className="site-header glass-panel">
        ...
        <nav className={`desktop-nav ${menuOpen ? 'is-open' : ''}`}>
          <a href="#empresa" onClick={handleNavClick}>
            <span className="nav-index">01</span>
            Empresa
          </a>

          <a href="#servicos" onClick={handleNavClick}>
          ...
          <a href="#processo" onClick={handleNavClick}>
            <span className="nav-index">04</span>
            Processo
          </a>

          <a href="#consultar" onClick={handleNavClick}>
      ...
      <main>
        <section id="inicio" className="hero-section page-section">
          ...
          <div className="hero-content">
            ...
            <div className="hero-bottom reveal reveal-delay-2">
              <p>
                Criamos experiências digitais, sistemas e automações para
                empresas que querem evoluir sua presença e sua operação.
              </p>

              <a
                href="#empresa"
                className="circle-link glass-circle"
                aria-label="Conhecer a Aporte"
              >
          ...
          <div className="hero-visual">
            ...
            <div className="visual-label glass-chip label-bottom">
              build · evolve
            </div>
            ...
            <div className="visual-data glass-data data-one">
              <span>FOCUS</span>
              <strong>01</strong>
            </div>

            <div className="visual-data glass-data data-two">
              <span>STATUS</span>
        ...
        >
          <div className="section-heading scroll-reveal">
            ...
            <p>
              A Aporte cria soluções digitais para empresas que precisam ir
              além de apenas estar presentes na internet.
            </p>
          </div>
          ...
          <div className="project-stage scroll-reveal">
            <div className="company-visual glass-panel">
              ...
              <div className="company-floating company-floating-one glass-panel">
                <Code2 size={15} />
                <span>BUILD</span>
              </div>

              <div className="company-floating company-floating-two glass-panel">
                <Network size={15} />
                <span>CONNECT</span>
              </div>
            </div>
            ...
            <div className="project-info">
              <div className="project-count">
                <span>APORTE</span> / SOBRE NÓS
              </div>

              <h3>
                Não entregamos apenas
                <br />
                <em>páginas bonitas.</em>
              </h3>

              <p>
                Pensamos no problema, na jornada e no resultado. Cada projeto
                começa pela estratégia e é construído para ter uma função real
                dentro do negócio.
              </p>
        ...
        <section id="servicos" className="solutions-section page-section">
          <div className="section-heading compact scroll-reveal">
            ...
            <p>
              Soluções pensadas de acordo com o estágio, objetivo e necessidade
              de cada empresa.
            </p>
          </div>
        ...
        <section id="portfolio" className="projects-section page-section">
          <div className="section-heading scroll-reveal">
            ...
            <p>
              Uma seleção de experiências e produtos digitais desenvolvidos
              para explorar diferentes desafios e possibilidades.
            </p>
          </div>
          ...
          <div className="portfolio-layout scroll-reveal">
            <div className="portfolio-feature">
              <div
                className={`project-visual portfolio-project project-art-${currentProject.visual}`}
                data-accent={currentProject.accent}
              >
                <div className="browser-bar">
                  <span />
                  <span />
                  <span />
                  <b>aporte.digital/{currentProject.url}</b>
                </div>
                ...
                <div className="portfolio-preview">
                  {currentProject.visual === 'rebeca' && (
                    <>
                      ...
                      <div className="preview-rebeca-photo">
                  ...
                  {currentProject.visual === 'agenda' && (
                    <>
                      <aside className="preview-agenda-sidebar">
                        <strong>A</strong>
                        <i />
                        <i />
                        <i />
                      ...
                      <div className="preview-agenda-main">
                        ...
                        <div className="agenda-cards">
                          <div className="agenda-card agenda-card-main">
                            <span>PRÓXIMO HORÁRIO</span>
                            <strong>09:30</strong>
                            <small>Manicure · Amanda</small>
                          </div>
                  ...
                  {currentProject.visual === 'clinic' && (
                    <>
                      ...
                      <div className="preview-clinic-image">
                        <div className="clinic-sun" />
                        <div className="clinic-portrait" />
                      </div>
                    </>
                  )}
                </div>
                ...
                <div className="project-preview-label">
                  ...
                  <span>{currentProject.id} / 03</span>
                </div>
              </div>
            </div>
            ...
            <div className="portfolio-info">
              <span className="project-count">
                {currentProject.id} <span>/ 03</span>
              </span>
            ...
            {projects.map((project, index) => (
              <button
                ...
                className={`portfolio-card scroll-reveal ${
                  activeProject === index ? 'portfolio-card-active' : ''
                }`}
                onClick={() => setActiveProject(index)}
        ...
        <section id="processo" className="process-section page-section">
          <div className="process-intro scroll-reveal">
            ...
            <p>
              Um processo claro para transformar necessidades reais em soluções
              digitais que façam sentido para o negócio.
            </p>
          ...
          <div className="process-story">
            ...
            <div className="process-result glass-panel scroll-reveal">
              ...
              <div className="result-icon glass-circle">
                <Sparkles size={22} />
              </div>
            </div>
          </div>
        ...
        <section className="tech-section page-section">
          <div className="tech-copy scroll-reveal">
            ...
            <p>
              Escolhemos a tecnologia de acordo com o problema. O objetivo não
              é usar mais ferramentas, mas construir a combinação certa.
            </p>
          </div>
          ...
          <div className="tech-map scroll-reveal">
            ...
            <div className="tech-node glass-node node-center">
            ...
            <div className="tech-node glass-node node-react">
              <div className="tech-node-content">
                <Code2 size={18} />
                <span>WEB</span>
              </div>
            ...
            <div className="tech-node glass-node node-data">
              <div className="tech-node-content">
                <Database size={18} />
                <span>DATA</span>
              </div>
            ...
            <div className="tech-node glass-node node-api">
              <div className="tech-node-content">
                <Network size={18} />
                <span>API</span>
              </div>
            ...
            <div className="tech-node glass-node node-auth">
              <div className="tech-node-content">
                <Zap size={18} />
                <span>AUTO</span>
              </div>
          ...
          <div className="tech-list scroll-reveal">
            ...
            <span className="glass-chip">APIs</span>
            <span className="glass-chip">Automação</span>
            <span className="glass-chip">UX/UI</span>
          </div>
        </section>
        ...
        <section id="consultar" className="contact-section">
          ...
          <div className="contact-meta glass-chip scroll-reveal">
            <span>APORTE / CONSULTA DE PROJETO</span>
            <span>2026</span>
          </div>
          ...
          <h2 className="scroll-reveal">
            Tem uma ideia
            <br />
            que merece <em>sair do papel?</em>
          </h2>
          ...
          <a
            ...
            rel="noreferrer"
          >
            <span>CONSULTAR UM PROJETO</span>
            <Send size={18} />
          </a>

          <p className="scroll-reveal">
            Conte o que você precisa. Vamos entender juntos qual é o próximo
            passo.
          </p>
        </section>
      </main>
